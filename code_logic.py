...
def extract_yolo_output_text_with_paddleocr(output):
  """Extracts the text output from a YOLO model prediction using PaddleOCR.

  Args:
    output: A string containing the output from the YOLO model prediction.

  Returns:
    A list of strings, where each string is the text extracted from the
    bounding box with the highest percentage confidence.
  """
